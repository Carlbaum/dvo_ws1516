...
int main(int argc, char *argv[])
{
    ...
    std::string fileGray0 = "rgb/1305031102.175304.png";
    std::string fileGray1 = "rgb/1305031102.275326.png";
    std::string fileDepth0 = "depth/1305031102.160407.png";
    std::string fileDepth1 = "depth/1305031102.262886.png";
    cv::Mat grayRef = loadIntensity(dataFolder + fileGray1);
    cv::Mat depthRef = loadDepth(dataFolder + fileDepth1);
    cv::Mat grayCur = loadIntensity(dataFolder + fileGray0);
    cv::Mat depthCur = loadDepth(dataFolder + fileDepth0);
    ...
    {
	int width = w/powf(2,level-1);
	int height = h/powf(2,level-1);
	// initialize intrinsic matrix
